...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{asset/interactive_flow/location}
...
\subsubsection{Textual narrative}
\usecasetable
    {You want to know some exercises you can do at home}
    {A user seeking to practice at home}
    {Their goal is to find exercises and instructions to practice yoga at home}
    {They access the web application from any personal device}
    {\begin{itemize}
         \item They access the \textit{Home page} of the website
         \item They navigate to the \textit{About} page using the navigation bar. Then, they click on the
         \textit{Start now} button, which leads them to the \textit{Practice at home} page, where they can find a list of exercises, tutorial videos and some guidelines. Alternatively, they can access the \textit{Practice at home} page directly via the navigation bar.
    \end{itemize}
    }
...
\subsubsection{Textual narrative}
\usecasetable
    {Your friend recommended you their favorite teacher, \textit{Chloe Dubois}, and you want to try some courses with her. Find her courses and then find how to attend three of her courses at the best price.}
    ...
    {\begin{itemize}
         ...
         \item They can click on any \textit{course card} to see price and description
    \end{itemize}
    }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{asset/interactive_flow/teacher}
    \caption{Use case 4: Find Chloe Dubois' courses}
\end{figure}
